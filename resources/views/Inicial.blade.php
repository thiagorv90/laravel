        ...
        <tr>
            ...
            <td><a href="/instancias/{{$instancia->cdInstancia}}" class="btn btn-info edit-btn">
                ...
                <a href="/instancias/edit/{{$instancia->cdInstancia}}" class="btn btn-info edit-btn">
                    ...
                    @endif
                    @if($instancia->dsEmail ==auth()->user()->email) <a href="/instancias/edit/{{$instancia->cdInstancia}}" class="btn btn-info edit-btn">
                        <ion-icon name="create-outline"></ion-icon> @endif
