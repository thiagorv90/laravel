...
<body>
    <header class="cabecalho">
        <nav class="navbar navbar-light bg-light fixed-top" style="background-image: linear-gradient(160deg, #743190 0%, #B67FB9 100%);">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="container-fluid funcionalidades">
                            <x-jet-responsive-nav-link class="btn btn-info" href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">
                                {{ __('Perfil') }}
