        ...
        <div id="event-create-container" class="col-md-10 offset-md-1">
            <form action="repsup" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input placeholder="Profissão..." type="text" class="form-control" id="dsProfissao"
                           name="dsProfissao">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="cdEscolaridade" id="cdEscolaridade" class="form-select">
                        @foreach ($escolaridades as $escolaridade)
                            <option
                                value="{{$escolaridade->cdEscolaridade}}"> {{$escolaridade->dsEscolaridade}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea placeholder="Endereço..." name="dsEndereco" id="dsEndereco"
