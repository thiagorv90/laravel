   ...
   @method('PUT')
    <div class="form-group">
      <label for="date">Nome:</label>
            <input type="text" class="form-control" id="nmRepresentanteSuplente" name="nmRepresentanteSuplente" value="{{$age->nmRepresentanteSuplente}}" >
    </div>
    <div class="form-group">
    ...
    @foreach($escola as $e)
        <option value="{{$e->cdEscolaridade}}"  @if ($age->cdEscolaridade == $e->cdEscolaridade) selected @endif >
            {{ $e->dsEscolaridade }}
        </option>
    @endforeach
    </select>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="dsEmailAlternativo" name="dsEmailAlternativo" value="{{$age->dsEmailAlternativo}}" >
    </div>
    <div class="form-group">
      <label for="title">Profissão:</label>
      <input type="text" class="form-control" id="dsProfissao" name="dsProfissao" value="{{$age->dsProfissao}}" >
    </div>
    <div class="form-group">
