  ...
  color: red;
    ...
    @if (is_countable($selecionado) && count($selecionado) == 0)
        ...
        @foreach ($telefones as $telefone)
            ...
            <h3>Crie Contato Telefonico para o(a): {{$telefone->nmContato}}</h3>
    ...
    @else
            ...
            <table class="table">
                ...
                @foreach ($selecionado as $event)
                    <tr>
                        ...
                        <td class="alterar-deletar" ><a id="teste" href="/telcon/edit/{{$event->cdTelefone}}"
        ...
        <div id="event-create-container" class="col-md-10 offset-md-1">
            ...
            <form action="telcon/" method="POST">
                ...
                <div class="form-group">
                    <label for="title">Telefone(somente numeros)</label>
