    ...
    <div class="container">
        ...
        <div class="container d-flex justify-content-evenly">
            <div class="list-group">
                ...
                <a href="dashboard/export/instanciasPorStatus" class="list-group-item list-group-item-action">4. Por Status</a>
            ...
            <div class="list-group">
                ...
                <a href="{{route('exportViewInstStatus')}}" class="list-group-item list-group-item-action">4. -- Por Status --</a>
                <a href="{{route('exportViewInstTema')}}" class="list-group-item list-group-item-action">5. -- Por Tema* --</a>
                <a href="{{route('exportViewInstPrioridade')}}" class="list-group-item list-group-item-action">6. -- Por Prioridade --</a>
                <a href="{{route('exportViewInstVigencia')}}" class="list-group-item list-group-item-action">7. -- Por Vigência de Mandato --</a>
                <a href="{{route('exportViewInstData')}}" class="list-group-item list-group-item-action">8. -- Por Data --</a>
                {{--            <li><a href="{{route('teste')}}">users</a></li>--}}
            </div>
        </div>
