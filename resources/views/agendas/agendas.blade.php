                ...
                @else
                    ...
                    <form action="/agendas/{{$event->cdAgenda}}/search" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="container">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="busca" id="busca" value="1"
                                           checked>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="busca" id="busca" value="2"
                                           checked>
                                    <label class="form-check-label" for="busca">
                                        Pauta
                                    </label>
                        ...
                        <div id="event-create-container" class="container">
                            <form action="agendas" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="title">Status:</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="stAgenda" id="stAgenda"
                                               value="1" checked>
                                        <label class="form-check-label" for="stAgenda">
                                            Ativo
                                        </label>
