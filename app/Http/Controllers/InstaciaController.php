...
class InstaciaController extends Controller
{
    public function storeinst(Request $request,$id){
     ...
     public function show($cdInstancia){
        ...
        ->get(['instancias.nmInstancia','tema_representacoes.nmTema','instituicoes.nmInstituicao','representante_suplentes.dsemail','representante_suplentes.nmRepresentanteSuplente',
