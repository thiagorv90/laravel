...
class RepresentanteSuplenteController extends Controller
{
   ...
   public function updateRepSup(Request $request, $id)
   {
      ...
      DB::update('update representante_suplentes set  nmRepresentanteSuplente = ?, dsEmail = ?, dsEmailAlternativo = ?, stAtivo = ?, dsProfissao = ?, cdEscolaridade = ?
     , cdEmpresa = ?, dsEndereco = ?, dtNascimento =?
