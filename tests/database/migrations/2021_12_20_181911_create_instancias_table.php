...
class CreateInstanciasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('instancias', function (Blueprint $table) {
            ...
            $table->foreign('cdInstituicao', 'PK_INSTITUICAO')->references('cdIntituicao')->on('instituicoes');
            $table->foreign('cdTema', 'PK_TEMA_REPRESENTACAO')->references('cdTema')->on('tema_representacoes');
        });
    }
